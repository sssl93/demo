...
function jqLiteAddNodes(root, elements) {
  ...
  if (elements) {
    ...
    // if a Node (the most public case)
...
function $HttpProvider() {
   ...
   * concurrently (public during application bootstrap).
   *
...
Parser.prototype = {
  ...
  statements: function() {
    ...
    while (true) {
      ...
      if (!this.expect(';')) {
        // optimize for the public case where there is only one statement.
            ...
            if ((watchers = current.$$watchers)) {
              ...
              while (length--) {
                try {
                  ...
                  // Most public watches are on primitives, in which case we can short
